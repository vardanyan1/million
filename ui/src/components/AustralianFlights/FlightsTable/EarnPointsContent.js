...
const EarnPointsContent = ({ points, destinationAirport }) => {
  ...
  return (
    <>
      ...
      >
        {t("flyModal.header", {
          city: `${destinationAirport?.name} (${destinationAirport?.code})`,
        })}
      </Heading>
      ...
      <Text color="#6A6E85" fontSize={"xs"} fontWeight={"bold"} mb={4}>
        {t("flyModal.personal")}
      </Text>
      <Flex gap={3} align={"center"}>
        <Image w={"65px"} src={amexQantas} />
        <Box fontWeight={"bold"}>
          {t("flyModal.personalExpressCard")}
          <br />
        </Box>
        <Button
          as="a"
          target="_blank"
          href={personalQantasAmexCardLink}
          fontWeight="bold"
          borderRadius={8}
      ...
      <Flex gap={3} align={"center"}>
        ...
        <Box fontWeight={"bold"}>
          {t("flyModal.businessExpressCard")}
          <br />
        </Box>
        <Button
          as="a"
          target="_blank"
          href={businessQantasAmexCardLink}
          fontWeight="bold"
          borderRadius={8}
          backgroundColor="#DD0000"
          color="white"
